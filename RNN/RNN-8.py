...
hidden_output = tf.compat.v1.keras.activations.sigmoid(tf.add(tf.matmul(x_data,A1),b1))
final_output = tf.compat.v1.keras.activations.sigmoid(tf.add(tf.matmul(hidden_output,A2),b2))
...
plt.savefig("img/RNN-7/perdida_")